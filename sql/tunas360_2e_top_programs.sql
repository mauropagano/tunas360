...
SELECT program,
  ...
  FROM (SELECT program,
               COUNT(*) samples
         FROM (SELECT position inst_id, object_owner program 
                 FROM plan_table
...
DEF title = 'Top Programs for Cluster';
...
DEF title = 'Top Programs for Instance 1';
...
DEF title = 'Top Programs for Instance 2';
...
DEF title = 'Top Programs for Instance 3';
...
DEF title = 'Top Programs for Instance 4';
...
DEF title = 'Top Programs for Instance 5';
...
DEF title = 'Top Programs for Instance 6';
...
DEF title = 'Top Programs for Instance 7';
...
DEF title = 'Top Programs for Instance 8';
