...
SELECT sql_id,
  ...
  FROM (SELECT sql_id,
               COUNT(*) samples
         FROM (SELECT position inst_id, remarks sql_id 
                 FROM plan_table
...
DEF title = 'Top SQL_IDs for Cluster';
...
DEF title = 'Top SQL_IDs for Instance 1';
...
DEF title = 'Top SQL_IDs for Instance 2';
...
DEF title = 'Top SQL_IDs for Instance 3';
...
DEF title = 'Top SQL_IDs for Instance 4';
...
DEF title = 'Top SQL_IDs for Instance 5';
...
DEF title = 'Top SQL_IDs for Instance 6';
...
DEF title = 'Top SQL_IDs for Instance 7';
...
DEF title = 'Top SQL_IDs for Instance 8';
