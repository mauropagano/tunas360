...
-- chart header
PRO    &&tunas360_conf_google_charts.
...
PRO  </head>
PRO  <body>
PRO <h1> &&tunas360_conf_all_pages_icon. &&section_id..&&report_sequence.. &&title.&&title_suffix. <em>(&&main_table.)</em> &&tunas360_conf_all_pages_logo. </h1>
PRO
PRO <br>
PRO &&abstract.
PRO &&abstract2.
...
-- footer
PRO<font class="n">Notes:<br>1) up to &&tunas360_max_time minutes of sampled data were considered<br>2) Reports are based on number of samples</font>
...
-- zip
HOS zip -mq &&tunas360_main_filename._&&tunas360_file_time. &&one_spool_filename._pie_chart.html
