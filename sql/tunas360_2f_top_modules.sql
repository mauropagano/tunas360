...
SELECT module,
  ...
  FROM (SELECT module,
               COUNT(*) samples
         FROM (SELECT position inst_id, object_name module 
                 FROM plan_table
...
DEF title = 'Top Modules for Cluster';
...
DEF title = 'Top Modules for Instance 1';
...
DEF title = 'Top Modules for Instance 2';
...
DEF title = 'Top Modules for Instance 3';
...
DEF title = 'Top Modules for Instance 4';
...
DEF title = 'Top Modules for Instance 5';
...
DEF title = 'Top Modules for Instance 6';
...
DEF title = 'Top Modules for Instance 7';
...
DEF title = 'Top Modules for Instance 8';
