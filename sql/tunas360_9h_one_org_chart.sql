...
@@tunas360_0o_html_header_org.sql
...
SELECT options
  FROM plan_table
 WHERE statement_id = 'tunas360_TREECOLOR'
   AND operation = '&&tunas360_sqlid.';
...
-- zip
HOS zip -mq &&tunas360_main_filename._&&tunas360_file_time. &&one_spool_filename._org_chart.html
