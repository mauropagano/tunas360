...
-- footer
PRO<font class="n">Notes:<br>1) drag to zoom, and right click to reset<br>2) up to &&tunas360_max_time minutes of sampled data were considered</font>
...
-- zip
HOS zip -mq &&tunas360_main_filename._&&tunas360_file_time. &&one_spool_filename._line_chart.html
